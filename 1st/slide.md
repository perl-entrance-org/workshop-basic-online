...
- ウェブアプリケーションを作ってみたいものの、基礎から勉強したい人。
...
- <a href="https://twitter.com/Perl_Entrance" target="\_blank><ruby>Tiwtter<rt>ツイッター</rt> アカウント [@Perl_Entrance]</a>
...
Larry は「プログラミング言語は、いろんな対象をシンプルに記述する為に、ある程度複雑でなければならない」と考えました。

Perl は同じ意味を持つ処理を、様々な書き方で表すことができます。

練習問題で自分が書いた書き方、講師の書き方、サポーターの書き方、受講生仲間の書き方・・・それぞれから学ぶところがあります。
...
先に述べたように、日本中の Perl コミュニティが、定期的/不定期に勉強会を開催しています。
