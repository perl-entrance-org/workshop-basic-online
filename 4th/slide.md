...
'Alice', 'Bob', 'Chris'の3名が格納された配列リファレンス `$students_ref` を、無名配列を使って1行で作成してみよう。
...
## 配列リファレンスを使う
### 練習問題（address.pl）
3人分の連絡先が格納された、アドレス帳の配列を作ってみましょう。
各人のアドレス（名前、電話番号、メールアドレス）は、1つの配列リファレンスでまとめましょう。

名前・電話番号・メールアドレスを1つの配列リファレンスにまとめる(３つの配列リファレンスを作る)
```
...
1. 先ほどの練習問題で作ったアドレス帳のプログラムを改造して、Bobのe-mailアドレスを画面に表示してみましょう。

2. Chrisの電話番号を画面に表示してみましょう。

3. 3名のe-mailアドレスのみを順番に画面に表示してみましょう。
___
